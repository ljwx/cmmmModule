 ...
 * Description:
 */
public class Algorithm_V111 implements IAlgorithm {
    ...
    public int verifyLinkCode(String linkCode) {
        ...
        if (mAlgorithmContext == null) {
            mAlgorithmContext = NativeAlgorithmLibraryV1_1_1.getAlgorithmContextFromNative();
        }
        return NativeAlgorithmLibraryV1_1_1.initAlgorithmContext(mAlgorithmContext, 0, linkCode);
    }
    ...
    public void initAlgorithmContext(DeviceEntity deviceEntity) {
        ...
        if (ObjectUtils.isNotEmpty(algorithmContext)) {
            NativeAlgorithmLibraryV1_1_1.setJsonAlgorithmContext(mAlgorithmContext, algorithmContext);
    ...
    public void saveAlgorithmContext(String userId,String deviceName, int index) {
        ...
        AppDatabase.getInstance().getDeviceDao().updateAlgorithm(userId,deviceName, NativeAlgorithmLibraryV1_1_1.getJsonAlgorithmContext(mAlgorithmContext), index);
    }
    ...
    public float loadData(int index, float currentData, float tempData, float bgData, float lowAlarmValue, float highAlarmValue) {
        ...
        double valueDB =  NativeAlgorithmLibraryV1_1_1.processAlgorithmContext(mAlgorithmContext, index,
    ...
    public void releaseAlgorithmContext(String userId,String deviceName) {
        if (mAlgorithmContext != null) {
            NativeAlgorithmLibraryV1_1_1.releaseAlgorithmContext(mAlgorithmContext);
