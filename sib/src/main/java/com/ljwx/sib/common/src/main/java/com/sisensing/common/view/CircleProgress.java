...
import com.sisensing.common.utils.MiscUtil;
...
public class CircleProgress extends View {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        mStartAngle = typedArray.getFloat(R.styleable.CircleProgress_startAg, Constant.DEFAULT_START_ANGLE);
     ...
     * @param color
     */
    public void setBgArcColor(int color) {
        mBgArcColor = color;
        mBgArcPaint.setColor(mBgArcColor);
    }
