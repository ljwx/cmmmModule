 ...
 * @Description:
 */
public abstract class BaseActivity<V extends ViewDataBinding, VM extends BaseViewModel> extends BaseMvvmActivity<V, VM> implements IBaseView {
...
//    private FragmentTransaction fragmentTransaction = null;
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        if (ev.getAction() == MotionEvent.ACTION_DOWN) {
            Log.d("baseActivity", "ACTION_DOWN");
            View view = getCurrentFocus();
            if (isHideInput(view, ev)) {
                Log.d("baseActivity", "isHideInput");
                HideSoftInput(view.getWindowToken());
                Log.d("baseActivity", "clearFocus");
                view.clearFocus();
            }
        }
