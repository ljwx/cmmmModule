 ...
 */
public abstract class BaseMvvmActivityV2<V extends ViewDataBinding, VM extends BaseViewModel<?>> extends BaseSibMVVMActivity<V, VM> implements IBaseLogic, IBaseView {
    protected V binding;
    ...
    protected void registerUIChangeLiveDataCallBack() {
        ...
        viewModel.getUC().getFinishEvent().observe(this, new Observer<Void>() {
            @Override
            public void onChanged(@Nullable Void v) {
                Log.i("gao","activity 监听到finish,调用关闭页面");
                finish();
            }
        });
        //关闭上一层
