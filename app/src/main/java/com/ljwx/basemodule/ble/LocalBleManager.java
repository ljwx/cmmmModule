...
import com.sisensing.common.ble.LocalBleServiceProxy;
 ...
 * @Description:蓝牙管理类
 */
public final class LocalBleManager implements IBle {
    ...
    private LocalBleManager() {

    }

    private static class Inner {
        private static final LocalBleManager INSTANCE = new LocalBleManager();
    }

    public static LocalBleManager getInstance() {
    ...
    public void startConnect(FragmentActivity activity, final DeviceEntity entity, boolean reOpenBle) {
        ...
        if (mBleService == null) {
            LocalBleManager.getInstance().init(Utils.getApp());
