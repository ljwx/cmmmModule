package com.ljwx.basemodule.service
...
import com.ljwx.basemodule.MainActivity
import com.ljwx.basemodule.R
import com.ljwx.basemodule.second.SecondActivity
...
class TestForegroundService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        val mBuilder =
            NotificationCompat.Builder(getApplicationContext()).setAutoCancel(true);// 点击后让通知将消失
        mBuilder.setContentText("测试");
        mBuilder.setContentTitle("测试");
//        mBuilder.setSmallIcon(R.mipmap.app_icon_notification);
